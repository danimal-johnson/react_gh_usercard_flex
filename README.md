...
> I could have planned the graph implementation better. It worked fine until I added the search bar; now it updates each time the input field changes. I still prefer to use functional components when possible. I haven't found any cases where hooks can't handle state just as well as classes can.
